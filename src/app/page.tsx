...
import { Sparkles, Heart, ShieldCheck, Truck, ArrowRight, Star, Award, Paintbrush, Palette } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900 flex flex-col font-sans">
      ...
      <main className="flex-1">
        {/* HERO SECTION */}
        <section className="relative min-h-[82vh] flex items-center justify-center overflow-hidden bg-amber-950 text-amber-50">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 py-20">
            <div className="inline-flex items-center gap-2 bg-amber-900/80 border border-amber-600/60 text-amber-200 text-xs px-4 py-1.5 rounded-full backdrop-blur-md">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                className="w-full sm:w-auto bg-amber-700 hover:bg-amber-600 text-amber-50 px-8 py-3.5 rounded-xl font-bold text-base shadow-xl flex items-center justify-center gap-2 transition"
              >
                {homepage?.hero_cta_text || 'Explore Collection'} <ArrowRight className="w-5 h-5" />
              </Link>
              <Link
                href="/category/lippan-art"
                className="w-full sm:w-auto bg-amber-900/60 hover:bg-amber-900 text-amber-100 border border-amber-600/50 px-8 py-3.5 rounded-xl font-medium text-base backdrop-blur-md transition flex items-center justify-center gap-2"
              >
                <Palette className="w-4 h-4 text-amber-300" /> Shop Lippan Art
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-24 indian-motif-bg border-y border-amber-200/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div className="text-center space-y-2">
              <span className="text-xs uppercase tracking-widest text-amber-800 font-bold flex items-center justify-center gap-1">
                <Paintbrush className="w-3.5 h-3.5 text-amber-700" /> Artisan Studio Collections
              </span>
              <h2 className="font-serif text-3xl sm:text-4xl font-bold text-amber-950">Explore Craft Categories</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
              {categories.map((cat) => (
                <Link
                  ...
                  className="group relative rounded-2xl overflow-hidden aspect-3/4 border border-amber-300/80 hover:border-amber-700 transition shadow-md hover:shadow-xl"
                >
                  <img
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-4 text-center space-y-1">
                    <h3 className="font-serif font-bold text-amber-100 text-sm sm:text-base group-hover:text-amber-300 transition">
                      {cat.name}
                    </h3>
          ...
          <section className="py-16 sm:py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                  <span className="text-xs uppercase tracking-widest text-amber-800 font-bold flex items-center gap-1">
                    <Palette className="w-3.5 h-3.5" /> Handpicked Masterpieces
                  </span>
                  <h2 className="font-serif text-3xl font-bold text-amber-950">Featured Artworks</h2>
                </div>
                <Link
        ...
        {/* ABOUT THE ARTIST */}
        <section className="py-16 sm:py-24 bg-amber-100/40 border-y border-amber-200/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6">
                <span className="text-xs uppercase tracking-widest text-amber-800 font-bold flex items-center gap-1">
                  <Paintbrush className="w-3.5 h-3.5" /> About the Studio
                </span>
                ...
                <div className="p-6 bg-amber-50 border-l-4 border-amber-800 rounded-r-xl space-y-2 border border-amber-200/80">
                  <h4 className="font-serif font-bold text-amber-900 text-sm">Craft Philosophy</h4>
        ...
        <section className="py-16 sm:py-20 bg-stone-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-6 bg-white border border-amber-200/80 rounded-2xl space-y-3 text-center shadow-xs">
                <div className="w-12 h-12 rounded-full bg-amber-100 border border-amber-300 flex items-center justify-center text-amber-800 mx-auto">
                  <Heart className="w-6 h-6" />
                </div>
                <h3 className="font-serif font-bold text-amber-950 text-base">Made with Love & Soul</h3>
              ...
              <div className="p-6 bg-white border border-amber-200/80 rounded-2xl space-y-3 text-center shadow-xs">
                ...
                <h3 className="font-serif font-bold text-amber-950 text-base">Non-Toxic & Premium</h3>
                <p className="text-xs text-stone-600 leading-relaxed">
              ...
              <div className="p-6 bg-white border border-amber-200/80 rounded-2xl space-y-3 text-center shadow-xs">
                ...
                <h3 className="font-serif font-bold text-amber-950 text-base">Shatterproof Indian Shipping</h3>
                <p className="text-xs text-stone-600 leading-relaxed">
        ...
        {newArrivals.length > 0 && (
          <section className="py-16 sm:py-24 bg-amber-50/50 border-t border-amber-200/80">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                  <span className="text-xs uppercase tracking-widest text-amber-800 font-bold flex items-center gap-1">
                    <Paintbrush className="w-3.5 h-3.5" /> Fresh Off The Workbench
                  </span>
                  <h2 className="font-serif text-3xl font-bold text-amber-950">New Arrivals</h2>
                </div>
                <Link
        ...
        {/* TESTIMONIALS */}
        <section className="py-16 sm:py-24 bg-white border-t border-amber-200/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div className="text-center space-y-2">
              <span className="text-xs uppercase tracking-widest text-amber-800 font-bold">Customer Reviews</span>
              <h2 className="font-serif text-3xl font-bold text-amber-950">Loved Across India</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-amber-50/40 border border-amber-200 rounded-2xl space-y-3 shadow-xs">
                ...
                <div>
                  <p className="text-xs font-bold text-amber-950">Pooja Deshmukh</p>
              ...
              <div className="p-6 bg-amber-50/40 border border-amber-200 rounded-2xl space-y-3 shadow-xs">
                ...
                <div>
                  <p className="text-xs font-bold text-amber-950">Vikram Malhotra</p>
              ...
              <div className="p-6 bg-amber-50/40 border border-amber-200 rounded-2xl space-y-3 shadow-xs">
                ...
                <div>
                  <p className="text-xs font-bold text-amber-950">Ritu Singhania</p>
